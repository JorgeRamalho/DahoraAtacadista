...
const steps = [
  {
    n: "01",
    title: "Cadastre-se",
    text: "Preencha o formulário completo do Dahora Card.",
    href: "/#cadastro",
  },
  {
    n: "02",
    title: "Acesse sua área",
    text: "Entre com e-mail e senha para ver cartão e pontos.",
    href: "/area-cliente",
  },
  {
    n: "03",
    title: "Compre e pontue",
    text: "Use o CPF nas lojas. Em dúvida, o SAC 24h está pronto.",
    href: "/sac",
  },
];
...
export function HomeJourney() {
  return (
    <section className="section-pad" aria-label="Como funciona">
      <div className="container-page">
        ...
        <ol className="mt-12 grid list-none gap-8 p-0 md:grid-cols-3">
          {steps.map((step) => (
            <li key={step.n}>
              <span className="font-display text-5xl font-semibold text-dahora-mint/90">
                {step.n}
              </span>
