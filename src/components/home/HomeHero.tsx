  ...
  return (
    <section className="relative min-h-[88vh] overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 20% 80%, rgba(232,163,23,0.35), transparent 40%), radial-gradient(ellipse at 85% 25%, rgba(125,211,168,0.25), transparent 35%)",
        }}
      />
      ...
      <div className="container-page relative flex min-h-[88vh] flex-col justify-end pb-16 pt-28 md:justify-center md:pb-24 md:pt-20">
        ...
        <div className="mt-9 flex flex-wrap gap-3 animate-rise-delay-2">
          ...
          <Link
            href="/area-cliente"
            className="inline-flex items-center justify-center rounded-full border border-white/35 bg-white/10 px-7 py-3.5 font-semibold text-white backdrop-blur-md transition hover:bg-white/20"
          >
            Área do Cliente
          </Link>
        </div>
